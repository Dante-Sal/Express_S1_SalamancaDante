...
const ctrl = require('../controllers/coordinators.controller');

const coordinators = Router();
const coordinator = Router();
...
coordinators.get(`/:id`, ctrl.getByParamsId);

coordinator.post(`/`, ctrl.getByBodyId);
...
coordinator.post(`/campers/grade_status/:grade_status`, campersCtrl.listByGradeStatus);
